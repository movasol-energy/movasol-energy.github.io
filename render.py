...
pages = [
    ...
    ("en", "projects.html"),
    ("en", "services-design-and-build-services.html"),
    ("en", "services-technical-and-financial-consulting.html"),
    ("en", "services-development.html"),
    ("en", "services-testing-and-commissioning.html"),
    ("en", "services-certified-repairs.html"),
